...
{ OSCCON = 0b00001000; // External cristal
  ...
  /*Esta primera parte de la práctica 2 la hemos hecho sin comprobarlo con la placa pues, 
   *siendo torpes, no hemos guardado ninguna de las prácticas, y hemos usado el ingenio para reconstruirlas.
  */
}
